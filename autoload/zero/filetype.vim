...
function! s:DetectGrepTool(...) abort
    let l:tool = get(a:, 1, '')
...
function! zero#filetype#Args(...) abort
    let l:tool = get(a:, 1, '')
    let l:ft = get(a:, 2, '')
...
function! zero#filetype#RgArgs(...) abort
    return call('s:RgArgs', a:000)
endfunction

function! zero#filetype#GitArgs(...) abort
    return call('s:GitArgs', a:000)
endfunction
